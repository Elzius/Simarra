...
<a href="pagina.php">ATRAS</a>
    ...
    <div class="container">
        <form class="m-auto w-50 mt-2 mb-2" method="POST" enctype="multipart/form-data" action="acciones1/insertar.php">
        ...
        <table class="table table-sm table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="cargar1.php?id=<?php echo $id; ?>"><?php echo $valor ;?> descargar</a></td>
                    <td><?php echo $fecha ;?></td>
                    <td><a class='btn btn-secondary' href="editar1.php?id=<?php echo $id?>">Editar</a> <a class='btn btn-danger' href="acciones1/eliminar.php?id=<?php echo $id?>">Eliminar</a></td>
                </tr>
                <?php 
                    }
                ?>

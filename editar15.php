...
<body>
    <div class="container">
            <form class="m-auto w-50 mt-2 mb-2" method="POST" enctype="multipart/form-data" action="acciones15/editar.php">
                ...
                <a class="btn btn-warning btn-sm" href="index15.php">Regresar</a>
            </form>

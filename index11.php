...
<a href="pagina.php">ATRAS</a>
    ...
    <div class="container">
        <form class="m-auto w-50 mt-2 mb-2" method="POST" enctype="multipart/form-data" action="acciones11/insertar.php">
        ...
        <table class="table table-sm table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="cargar11.php?id=<?php echo $id; ?>"><?php echo $valor ;?> descargar</a></td>
                    <td><?php echo $fecha ;?></td>
                    <td><a class='btn btn-secondary' href="editar11.php?id=<?php echo $id?>">Editar</a> <a class='btn btn-danger' href="acciones11/eliminar.php?id=<?php echo $id?>">Eliminar</a></td>
                </tr>
                <?php 
                    }
                ?>
